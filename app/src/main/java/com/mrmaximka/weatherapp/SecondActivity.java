...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        latitude = Objects.requireNonNull(getIntent().getExtras()).getString(MainActivity.LATITUDE_COORD);
        longitude = Objects.requireNonNull(getIntent().getExtras()).getString(MainActivity.LONGITUDE_COORD);
